...
Bakery.create(name: "동규네 빵집", address: "경기도 안산시 단원구 이삭3길 30", telephone_number: "010-9196-9896", business_license: "11-11-11", email: "ehdrbchd@naver.com", image: open("app/assets/images/bakery7.jpg"), open_time: Time.now+(60*60*1), close_time: Time.now+(60*60*13), seat: 100, owner_id: 1)
Bakery.create(name: "민경이네 카페", address: "경기 과천시 경마공원대로 107", telephone_number: "010-5161-5998", business_license: "22-22-22", email: "alsrud@gmail.com", image: open("app/assets/images/bakery1.jpg"), open_time: Time.now+(60*60*2), close_time: Time.now+(60*60*7), seat: 1000)
Bakery.create(name: "서울바게트", address: "서울 용산구 남산공원길 105", telephone_number: "010-1111-1111", business_license: "33-33-33", email: "skek@daum.net", image: open("app/assets/images/bakery2.jpg"), open_time: Time.now+(60*60*3), close_time: Time.now+(60*60*6), seat: 35)
Bakery.create(name: "또래주르", address: "서울 동작구 남부순환로 2089", telephone_number: "010-2222-2222", business_license: "44-44-44", email: "qkqh@hanmail.net", image: open("app/assets/images/bakery3.jpg"), open_time: Time.now+(60*60*4), close_time: Time.now+(60*60*5), seat: 30)
Bakery.create(name: "멋쟁이빵집", address: "서울 마포구 양화로 160", telephone_number: "010-3333-3333", business_license: "55-55-55", email: "ajdchddl@naver.com", image: open("app/assets/images/bakery4.jpg"), open_time: Time.now+(60*60*1), close_time: Time.now+(60*60*4), seat: 20)
Bakery.create(name: "중앙대학교", address: "서울특별시 동작구 흑석로 84", telephone_number: "010-4444-4444", business_license: "66-66-66", email: "cau@cau.ac.kr", image: open("app/assets/images/bakery5.jpg"), open_time: Time.now+(60*60*2), close_time: Time.now+(60*60*3), seat: 40000)
Bakery.create(name: "오늘의빵빵", address: "서울 강남구 강남대로 396", telephone_number: "010-5555-5555", business_license: "77-77-77", email: "mm@naver.com", image: open("app/assets/images/bakery6.jpg"), open_time: Time.now+(60*60*3), close_time: Time.now+(60*60*15), seat: 130)
Bakery.create(name: "그냥날이좋아서", address: "경기 안양시 동안구 동안로 130", telephone_number: "010-6666-6666", business_license: "88-88-88", email: "nodap@naver.com", image: open("app/assets/images/bakery8.jpg"), open_time: Time.now+(60*60*1), close_time: Time.now+(60*60*10), seat: 30)
Bakery.create(name: "달콤살벌", address: "부산 해운대구 달맞이길62번길 47", telephone_number: "010-7777-7777", business_license: "99-99-99", email: "hello@gmail.com", image: open("app/assets/images/bakery9.jpg"), open_time: Time.now+(60*60*5), close_time: Time.now+(60*60*7), seat: 40)
